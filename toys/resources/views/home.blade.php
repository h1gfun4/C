    ...
    <div class="container">
      <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-4 text-center">
            <a class="blog-header-logo text-dark" href="#">template TOYS</a>
          </div>
      ...
      <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex justify-content-between">
          ...
          <a class="p-2 link-secondary" href="/shop">Shop</a>
          <a class="p-2 link-secondary" href="/about">About</a>
          <a class="p-2 link-secondary" href="/works">Works</a>
          <a class="p-2 link-secondary" href="/news">News</a>
          <a class="p-2 link-secondary" href="/life">Life</a>
          <a class="p-2 link-secondary" href="/garden">Garden</a>
          <a class="p-2 link-secondary" href="/recipe">Recipe</a>
          <a class="p-2 link-secondary" href="/motherhood">Motherhood</a>
